...
Point2D GoLeft::randomStartPoint(World* world) {
  auto sideOver2 = world->GetSize() / 2;
...
std::vector<Point2D> GoLeft::getVisitables(World* w, const Point2D& p) {
  auto sideOver2 = w->GetSize() / 2;
